...
from PIL import Image
from train import VlmConfig, VLM, MyDataCollator
import sys
...
def main(modelPath : str):
    ...
    images_path = os.path.join(modelPath, 'dataset/jingyaogong/minimind-v_dataset-ac9d03a/sft_images')
    data_path = os.path.join(modelPath, 'dataset/jingyaogong/minimind-v_dataset-ac9d03a/sft_data.jsonl')
    output_dir = 'save/sft' 
